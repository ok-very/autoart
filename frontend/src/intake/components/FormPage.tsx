...
export function FormPage() {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <h1 className="text-ws-h1 font-semibold text-slate-900 mb-2">Form Not Found</h1>
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center max-w-md mx-auto p-8">
          ...
          <h1 className="text-ws-h1 font-semibold text-slate-900 mb-2">Submitted!</h1>
  ...
  return (
    <div className="max-w-2xl mx-auto py-8 px-4">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-ws-h1 font-semibold text-slate-900">{form.title}</h1>
      ...
      {(currentPageData?.blocks_config?.settings as any)?.pageTitle && (
        <h2 className="text-ws-h2 font-semibold text-slate-800 mb-4">
          {(currentPageData.blocks_config.settings as any).pageTitle}
        </h2>
      )}
