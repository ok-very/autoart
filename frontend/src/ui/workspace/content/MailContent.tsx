...
const EmailRow = memo(function EmailRow({
    ...
    return (
        <tr
            ...
            className={`border-b border-ws-panel-border hover:bg-ws-bg cursor-pointer transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset ${isSelected ? 'bg-blue-50 hover:bg-blue-50' : ''}`}
        >
                ...
                <div className="flex items-center gap-2 mt-1">
                    ...
                    {linkedEntities.length > 0 ? (
                        ...
                        <button
                            ...
                            className="flex items-center gap-1 text-[10px] text-ws-muted hover:text-blue-500 transition-colors"
