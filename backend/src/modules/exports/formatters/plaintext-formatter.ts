 ...
 *
 * Formats BFA export models into plain text for simple viewing/copying.
 */

import type { BfaProjectExportModel, ExportOptions } from '../types.js';

/**
 * Format projects as plain text document.
 */
export function formatAsPlainText(
    ...
    if (publicProjects.length > 0) {
        ...
        for (const project of publicProjects) {
            lines.push(formatProjectPlainText(project, options));
            lines.push('');
        }
    }
 ...
 */
function formatProjectPlainText(
