...
FIELDS: tuple[FieldDef, ...] = (
    ...
    FieldDef(
        key="contact_sync_exchange_org",
        label="Exchange Organization",
        section="exchange",
        field_type="string",
        default="",
        admin_only=True,
    ...
    FieldDef(
        key="contact_sync_exchange_app_id",
        label="Azure App ID",
        section="exchange",
        field_type="string",
        default="",
        admin_only=True,
        row_group="exchange_auth",
    ),
    FieldDef(
        key="contact_sync_exchange_cert_thumbprint",
