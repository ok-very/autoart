...
export function MailPage() {
  ...
  return (
    <div className="h-screen flex flex-col bg-ws-bg">
      {/* Header */}
      <header className="bg-ws-panel-bg border-b border-ws-panel-border px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-semibold text-ws-fg">Mail Inbox</h1>
              <StatusIndicator />
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => refetch()}
              disabled={isFetching}
              className="flex items-center gap-2 px-3 py-2 text-sm text-ws-text-secondary hover:text-ws-fg hover:bg-slate-100 rounded-lg transition-colors disabled:opacity-50"
            >
      ...
      {data && data.total > ITEMS_PER_PAGE && (
        <footer className="bg-ws-panel-bg border-t border-ws-panel-border px-6 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                disabled={offset === 0}
                className="p-2 text-ws-text-secondary hover:bg-slate-100 rounded disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <ChevronLeft size={16} />
              </button>
              <span className="text-sm text-ws-text-secondary">
