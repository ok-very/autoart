...
const COLUMN_CONFIG: Record<NodeType, { label: string; badge: string; bgColor: string; textColor: string }> = {
    ...
    process: { label: 'Process', badge: 'Pr', bgColor: 'bg-purple-100', textColor: 'text-purple-600' },
    phase: { label: 'Phases', badge: 'F', bgColor: 'bg-yellow-100', textColor: 'text-yellow-600' },
