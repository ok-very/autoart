...
## Rules (see `.agent/rules/`)

| File | Covers |
|------|--------|
| `git-procedures.md` | Stacked PRs, merging, branch hygiene |
| `architecture.md` | Soft-intrinsic types, workspace system |
| `component-conventions.md` | Frontend patterns, file naming |
| `nomenclature.md` | Canonical terms, DB/API conventions |
| `pnpm-catalog.md` | Dependency versions, catalog usage |
| `shell-and-git.md` | Commit messages, gh CLI |
...
**Multi-phase plans require stacked PRs.** See `git-procedures.md`.
